				...
				<!-- Begining of work community -->
				 ...
				 <!-- Begining of secuirty community -->
				  ...
				  <span class=''> <a href='#'  onclick = 'notifications.getSpecificLabelNotifications(\"".PostImage::$sanitation."\");' title='incidents related to work'> <div class='ps-bubble__wrapper'>".ucwords(PostImage::$security)." <span class='js-counter ps-bubble ps-bubble--toolbar ps-js-counter'> ".$activities_counts["label"][PostImage::$security]." </span> </div> </a> <div  id='security_notifications_box' class='ps-popover app-box community_notifications_box' style='display: none;'><div style=' width: 10%; margin: 0px auto; display: none;'><img src='../public/assets/images/ajax-loader.gif' ></div><div class='ps-notifications ps-notifications--empty' style='max-height: 40vh; overflow: auto;'></div><div class='ps-popover-footer app-box-footer ps-clearfix'><a href=' ://demo.peepso.com/profile/demo/friends/requests'>View All</a></div></div></span>
					...
					<div class='ps-notifications ps-notifications--empty' style='max-height: 40vh; overflow: auto;'></div><div class='ps-popover-footer app-box-footer ps-clearfix'><a href=' ://demo.peepso.com/profile/demo/friends/requests'>View All</a></div></div></span> 
						
						<!-- End of education community -->
					<!-- Begining of other community -->

						<span class=''> <a href='#'
						onclick = 'notifications.getSpecificLabelNotifications(\"".PostImage::$other."\");'  title='Friend Requests'> <div class='ps-bubble__wrapper'>".ucwords(PostImage::$other)."<span class='js-counter ps-bubble ps-bubble--toolbar ps-js-counter'> ".$activities_counts["label"][PostImage::$other]." </span> </div> </a> <div class='ps-popover app-box  community_notifications_box' style='display: none;'><div class='ps-notifications ps-notifications--empty' style='max-height: 40vh; overflow: auto;'></div><div class='ps-popover-footer app-box-footer ps-clearfix'><a href=''>View All</a></div></div></span> <span class='dropdown-notification ps-js-notifications'> <div class='ps-popover app-box' style='display: none;'><div class='ps-notifications' style='max-height: 40vh; overflow: auto;'><div class='ps-notification ps-notification--unread ps-js-notification ps-js-notification--158' data-id='158' data-unread='1'>
