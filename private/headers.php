...
'>
  ...
  <div class='ps-toolbar__menu' title='communities(You will get more post from this community if you are part of it)'>
			 <span class=''> <a href='#' onclick = 'notifications.getSpecificLabelNotifications(\"".PostImage::$transport."\");' title='transport community'> <div class='ps-bubble__wrapper'>".ucwords(PostImage::$transport)."<span class='js-counter ps-bubble ps-bubble--toolbar ps-js-counter'>".$activities_counts["label"][PostImage::$transport]."  </span> </div> </a> <div  id='transport_notifications_box' class='ps-popover app-box notifications_box' style='display: none;'><div  class='notifications_loader'style=' width: 10%; margin: 0px auto; display: none;'><img src='../public/assets/images/ajax-loader.gif' ></div><div class='ps-notifications ps-notifications--empty' style='max-height: 40vh; overflow: auto;'></div><div class='ps-popover-footer app-box-footer ps-clearfix'><a href=' ://demo.peepso.com/profile/demo/friends/requests'>View All</a></div></div></span>

				<!-- End of transport community -->
				<!-- Begining of health community -->

				 <span class=''> <a href='#' onclick = 'notifications.getSpecificLabelNotifications(\"".PostImage::$health."\");' title='health community'> <div class='ps-bubble__wrapper'>".PostImage::$health."<span class='js-counter ps-bubble ps-bubble--toolbar ps-js-counter'> ".$activities_counts["label"][PostImage::$health]." </span> </div> </a> <div  id='health_notifications_box' class='ps-popover app-box notifications_box' style='display: none;'><div class='notifications_loader' style=' width: 10%; margin: 0px auto; display: none;'><img src='../public/assets/images/ajax-loader.gif' ></div><div class='ps-notifications ps-notifications--empty' style='max-height: 40vh; overflow: auto;'></div><div class='ps-popover-footer app-box-footer ps-clearfix'><a href='work.php'>View All</a></div></div></span>
				 
				 <!-- End of health community -->
				<!-- Begining of work community -->

				  <span class=''> <a href='#'  onclick = 'notifications.getSpecificLabelNotifications(\"".PostImage::$work."\");' title='issues related to employment / work'> <div class='ps-bubble__wrapper'>".ucwords(PostImage::$work)." <span class='js-counter ps-bubble ps-bubble--toolbar ps-js-counter'> ".$activities_counts["label"][PostImage::$work]." </span> </div> </a> <div  id='work_notifications_box' class='ps-popover app-box notifications_box' style='display: none;'><div style=' width: 10%; margin: 0px auto; display: none;'><img src='../public/assets/images/ajax-loader.gif' ></div><div class='ps-notifications ps-notifications--empty' style='max-height: 40vh; overflow: auto;'></div><div class='ps-popover-footer app-box-footer ps-clearfix'><a href=' '>View All</a></div></div></span>
				  
				  	 
				 <!-- End of work community -->
				 <!-- Begining of sol community -->

				  <span class=''> <a href='#'  onclick = 'notifications.getSpecificLabelNotifications(\"".PostImage::$sol."\");' title='incidents related to standard of living in the country'> <div class='ps-bubble__wrapper'>".ucwords(PostIMage::$sol)."<span class='js-counter ps-bubble ps-bubble--toolbar ps-js-counter'> ".$activities_counts["label"][PostImage::$sol]." </span> </div> </a> <div   id='sol_notifications_box' class='ps-popover app-box  notifications_box' style='display: none;'><div class='notifications_loader' style=' width: 10%; margin: 0px auto; display: none;'><img src='../public/assets/images/ajax-loader.gif' ></div><div class='ps-notifications ps-notifications--empty' style='max-height: 40vh; overflow: auto;'></div><div class='ps-popover-footer app-box-footer ps-clearfix'><a href=''>View All</a></div></div></span> 

				   	 
				 <!-- End of sol community -->
				 <!-- Begining of sanitation community -->

				  <span class=''> <a href='#'  onclick = 'notifications.getSpecificLabelNotifications(\"".PostImage::$sanitation."\");' title='incidents related to sanitation in the country'> <div class='ps-bubble__wrapper'>".ucwords(PostImage::$sanitation)." <span class='js-counter ps-bubble ps-bubble--toolbar ps-js-counter'> ".$activities_counts["label"][PostImage::$sanitation]." </span> </div> </a> <div  id='sanitation_notifications_box' class='ps-popover app-box notifications_box' style='display: none;'><div style=' width: 10%; margin: 0px auto; display: none;'><img src='../public/assets/images/ajax-loader.gif' ></div><div class='ps-notifications ps-notifications--empty' style='max-height: 40vh; overflow: auto;'></div><div class='ps-popover-footer app-box-footer ps-clearfix'><a href=''>View All</a></div></div></span>
				 ...
				 <!-- Begining of secuirty community -->
				  ...
				  <span class=''> <a href='#'  onclick = 'notifications.getSpecificLabelNotifications(\"".PostImage::$sanitation."\");' title='incidents related to work'> <div class='ps-bubble__wrapper'>".ucwords(PostImage::$security)." <span class='js-counter ps-bubble ps-bubble--toolbar ps-js-counter'> ".$activities_counts["label"][PostImage::$security]." </span> </div> </a> <div  id='security_notifications_box' class='ps-popover app-box notifications_box' style='display: none;'><div style=' width: 10%; margin: 0px auto; display: none;'><img src='../public/assets/images/ajax-loader.gif' ></div><div class='ps-notifications ps-notifications--empty' style='max-height: 40vh; overflow: auto;'></div><div class='ps-popover-footer app-box-footer ps-clearfix'><a href=' ://demo.peepso.com/profile/demo/friends/requests'>View All</a></div></div></span>
					...
					<span class=''> <a href='#' onclick = 'notifications.getSpecificLabelNotifications(\"".PostImage::$education."\");' title='You will get updated about all the other communities'> <div class='ps-bubble__wrapper'>".ucwords(PostImage::$education)."<span class='js-counter ps-bubble ps-bubble--toolbar ps-js-counter'> ".$activities_counts["label"][PostImage::$education]." </span> </div> </a> <div id='other_notifications_box' class='ps-popover app-box notifications_box' style='display: none;'>
