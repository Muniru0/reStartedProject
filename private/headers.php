  ...
  <div class='ps-toolbar__menu' title='communities(You will get more post from this community if you are part of it)'>
			 <span class=''> <a href='#' onclick = 'notifications.getSpecificLabelNotifications(\"".PostImage::$transport."\");' title='transport community'> <div class='ps-bubble__wrapper'>".ucwords(PostImage::$transport)."<span class='js-counter ps-bubble ps-bubble--toolbar ps-js-counter'>".$activities_counts["label"][PostImage::$transport]."  </span> </div> </a> <div  id='transport_notifications_box' class='ps-popover app-box notifications_box' style='display: block;'><div style=' width: 10%; margin: 0px auto; display: none;'><img src='../public/assets/images/ajax-loader.gif' ></div><div class='ps-notifications ps-notifications--empty' style='max-height: 40vh; overflow: auto;'></div><div class='ps-popover-footer app-box-footer ps-clearfix'><a href=' ://demo.peepso.com/profile/demo/friends/requests'>View All</a></div></div></span>
				...
				<!-- Begining of health community -->
				 ...
				 <span class=''> <a href='#' onclick = 'notifications.getSpecificLabelNotifications(\"".PostImage::$health."\");' title='health community'> <div class='ps-bubble__wrapper'>".PostImage::$health."<span class='js-counter ps-bubble ps-bubble--toolbar ps-js-counter'> ".$activities_counts["label"][PostImage::$health]." </span> </div> </a> <div  id='health_notifications_box' class='ps-popover app-box notifications_box' style='display: none;'><div style=' width: 10%; margin: 0px auto; display: none;'><img src='../public/assets/images/ajax-loader.gif' ></div><div class='ps-notifications ps-notifications--empty' style='max-height: 40vh; overflow: auto;'></div><div class='ps-popover-footer app-box-footer ps-clearfix'><a href='work.php'>View All</a></div></div></span>
				...
				<!-- Begining of work community -->
				 ...
				 <!-- Begining of sol community -->
				  ...
				  <span class=''> <a href='#'  onclick = 'notifications.getSpecificLabelNotifications(\"".PostImage::$sol."\");' title='incidents related to standard of living in the country'> <div class='ps-bubble__wrapper'>".ucwords(PostIMage::$sol)."<span class='js-counter ps-bubble ps-bubble--toolbar ps-js-counter'> ".$activities_counts["label"][PostImage::$sol]." </span> </div> </a> <div   id='sol_notifications_box' class='ps-popover app-box  notifications_box' style='display: none;'><div style=' width: 10%; margin: 0px auto; display: none;'><img src='../public/assets/images/ajax-loader.gif' ></div><div class='ps-notifications ps-notifications--empty' style='max-height: 40vh; overflow: auto;'></div><div class='ps-popover-footer app-box-footer ps-clearfix'><a href=''>View All</a></div></div></span> 
