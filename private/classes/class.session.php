...
// Actions to preform after every successful login
 public static function after_successful_login() {
  ...
  $_SESSION[PostImage::$transport]  = 0;
	$_SESSION[PostImage::$health]   	= 0;
	$_SESSION[PostImage::$work]   	  = 0;
	$_SESSION[PostImage::$sol] 				= 0;
	$_SESSION[PostImage::$security]   = 0;
	$_SESSION[PostImage::$sanitation] = 0;
	$_SESSION[PostImage::$education]  = 0;
  $_SESSION[PostImage::$other]      = 0;
