...
<head>
    ...
    window._wpemojiSettings = {
        ...
        "svgExt": ".svg",
        "source": {
            "concatemoji": "assets1\/js\/wp-emoji-release.min.js"
        }
    };
    ! function(a, b, c) {
        function d(a, b) {
    ...
    <script src="assets1/js/wp-emoji-release.min.js" type="text/javascript" defer=""></script>
...
<body
    class="home page-template page-template-page-tpl-community page-template-page-tpl-community-php page page-id-5 plg-peepso"
    id="top">
    <div class="top__button">
        <a class="btn btn--red" href="#top"><svg class="svg-inline--fa fa-angle-up fa-w-10" aria-hidden="true"
            ...
            </svg><!-- <i class="fas fa-angle-up"></i> --></a>
    </div>
    <div class="page__wrapper">
        <div class="header__wrapper header__wrapper--medium">
            <div class="header">
                <div id="userbar" class="header__account">
                    <div class="widget_text widget header__widget">
                        <div class="textwidget custom-html-widget">
                            <div class="ultimate__box-actions" style="margin-left: 30px;"><a class="btn btn--sm"
                                    style="display:block;" href="http://peep.so/bundle"><strong>NatNet</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul class="header__menu">
                    <li id="menu-item-149"
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-5 current_page_item menu-item-149">
                        <a href="https://demo.peepso.com/">Community</a></li>
                    <li id="menu-item-148"
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-148"><a
                            href="https://demo.peepso.com/profile/">Profile</a></li>
                    <li id="menu-item-663"
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-663"><a
                            href="https://demo.peepso.com/members/">Members</a></li>
                    <li id="menu-item-664"
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-664"><a
                            href="https://demo.peepso.com/classifieds/">Classifieds</a></li>
                    <li id="menu-item-150"
                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-150"><a target="_blank"
                            href="/wp-admin/">Login to Admin</a></li>
                ...
                <div class="header__actions">
                    <a class="header__toggle header__toggle--account" href="#userbar">
                        <svg class="svg-inline--fa fa-user-alt fa-w-16" aria-hidden="true" data-prefix="fas"
                            data-icon="user-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                            data-fa-i2svg="">
                            <path fill="currentColor"
                                d="M256 288c79.5 0 144-64.5 144-144S335.5 0 256 0 112 64.5 112 144s64.5 144 144 144zm128 32h-55.1c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16H128C57.3 320 0 377.3 0 448v16c0 26.5 21.5 48 48 48h416c26.5 0 48-21.5 48-48v-16c0-70.7-57.3-128-128-128z">
                            </path>
                        </svg><!-- <i class="fas fa-user-alt"></i> -->
                    </a>
...
">
                                    ...
                                    <section id="component" role="article" class="ps-clearfix">
                                        <noscript>
                                            <div class="alert alert-error pstd-important">
                                                <span style="color: #ff0000;">Please Note:</span> PeepSo requires the
                                                use of Javascript
                                                for proper operation. Please enable Javascript in order to experience
                                                the full capabilities
                                                of the application. You may also visit our website for
                                                <a href="http://peepso.com/enabling-javascript">more information about
                                        ...
                                        <div class="ps-landing">
                                            <div class="ps-landing-cover">
                                                <div class="ps-landing-image"
                                                    style="background:url('assets/images/203-rain-computer-background-photos-downloads-backgrounds-wallpapers_2.jpg');background-size:cover">
                                                </div>
                                                ...
                                                <div class="ps-landing-content">
                                                    ...
                                                    <div class="ps-landing-signup">
                                                        <a class="ps-btn ps-btn-join"
                                                            href="https://demo.peepso.com/register/">Let's Network To
                                                            Build The Nation</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div id="registration" class="ps-landing-action">
                                                <div class="alert alert-danger" id="login_err" role="alert"
                                                    style="display:none;">
    ...
    bottom: 0.1em;">×</span>
                                                ...
                                                <div class="login-area">
                                                    <form class="ps-form ps-js-form-login" method="post" name="login"
                                                        id="form">
                                                        <?php echo  csrf_token_tag(); ?><div class="ps-landing-form">
                                                            <div class="ps-form-input ps-form-input-icon">
                                                                <span class="ps-icon"><i
                                                                        class="ps-icon-user"></i></span>
                                                                <input class="ps-input" type="text" id="email"
                                                                    name="email" placeholder="Email" mouseev="true"
                                                                    autocomplete="off" keyev="true" clickev="true">
                                                            </div>
                                                            <div class="ps-form-input ps-form-input-icon">
                                                                <span class="ps-icon"><i
                                                                        class="ps-icon-lock"></i></span>
                                                                <input class="ps-input" id="password" type="password"
                                                                    name="password" placeholder="Password"
                                                                    mouseev="true" autocomplete="off" keyev="true"
                                                                    clickev="true">
                                                            </div>
                                                            <div class="ps-form-input ps-form-input--button">
                                                                <button type="submit" id="button_login" name="submit"
                                                                    class="ps-btn ps-btn-login">
                                                                    <span>Login</span>
                                                        ...
                                                        <div class="ps-checkbox">
                                                            <input type="checkbox" alt="Remember Me" value="yes"
                                                                id="remember" name="remember">
                                                            <label for="remember">Remember Me</label>
                                                        </div>
                                                        <a class="ps-link ps-link--recover" href="signup.php">Recover
                                                            Password</a>
                                                        <a class="ps-link ps-link--recover"
                                                            href="signup.php">Register</a>
                                                        <a class="ps-link ps-link--activation ps-js-register-activation"
                                                            href="https://demo.peepso.com/register/?resend"
                                                            style="display: none;">Resend activation code</a>
                                                        <!-- Alert -->
                                                        <div class="errlogin calert clear alert-error"
