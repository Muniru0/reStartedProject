...
<br />
  ...
  <form action=\"work.php\" method=\"POST\" enctype=\"multipart/form-data\" class=\"well-work span6 form-horizontal\" name=\"ajax-demo\" id =\"ajax-demo\">
...
<form action=\"work.php\" method = \"POST\" enctype=\"multipart/form-data\">
  ...
  work :<input type=\"radio\" id=\"radio\" name = \"label\"  value = \"work\"  ".((isset($label) && $label == "work")  ? "checked = 'checked'" : "")." />
...
<!-- the post text area -->
<form action=\"work.php\" method = \"POST\" enctype=\"text/plain\" >
work :<input type=\"radio\" id=\"radio\" name = \"text_label\"  value = \"work\"  ".((isset($text_label) && $text_label == "work")  ? "checked = 'checked'" : "")." />
