...
<br />
  ...
  <form action=\"health.php\" method=\"POST\" enctype=\"multipart/form-data\" class=\"well-health span6 form-horizontal\" name=\"ajax-demo\" id =\"ajax-demo\">
...
<!-- the post text area -->
<form action=\"health.php\" method = \"POST\" enctype=\"text/plain\" >
...
// }
 ...
 $result = FetchPost::top_specific_trends("WHERE interest = '".$interest."'  ");
