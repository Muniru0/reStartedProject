...
// check that they are not being throttled before 
  ...
  if(throttle::throttle_user()){
    ...
    after_successful_login();
        ...
        throttle::clear_failed_logins($email);
           $redirect = [1];
...
<link rel="stylesheet" href="assets1/css/peepso-site-06-06.css" />
<link rel="stylesheet" href="assets1/css/template-rounded.css" />
          
<!--<link rel="stylesheet" href="assets1/css/style.css" />-->
   

<script type="text/javascript" src="assets1/js/fontawesome-all.min.js" defer></script>
<!--  DO NOT DEFER jquery or else the script will not find it ---->        
<script type="text/javascript" src="assets1/jquery.js" ></script>
<script type="text/javascript" src="../includes/assets/js/login.js" defer></script>
...
<div class="alert alert-error pstd-important">
	...
	Thank you!
		...
		<div class="ps-landing-image" style="background:url('assets1/images/clientbg.jpg');background-size:cover"></div>
      ...
      <div class="ps-landing-form">
        ...
        <div class="ps-form-input ps-form-input--button">
          <button type="submit" id="button_login" name="submit" class="ps-btn ps-btn-login">
            <span>Login</span>
            <img style="display:none" src="assets1/images/ajax-loader.gif">
          </button>
        </div>
</div>
