...
<br />
  ...
  <form action=\"transport.php\" method=\"POST\" enctype=\"multipart/form-data\" class=\"well-transport span6 form-horizontal\" name=\"ajax-demo\" id =\"ajax-demo\">
...
<form action=\"transport.php\" method = \"POST\" enctype=\"multipart/form-data\">


  <input type = \"file\" name = \"files[]\" id= \"files\"multiple/>
  <input type=\"text\" id=\"title\" name=\"caption\" placeholder=\"caption\" value = \"".(isset($caption) && !empty(trim($caption)) ? $caption : "")."\" />
  
  Transport :<input type=\"radio\" id=\"radio\" name = \"label\"  value = \"transport\"  ".((isset($label) && $label == "transport")  ? "checked = 'checked'" : "")." />
...
<!-- the post text area -->
<form action=\"transport.php\" method = \"POST\" enctype=\"text/plain\" >
