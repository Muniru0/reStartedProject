...
<br />
  ...
  <form action=\"sol.php\" method=\"POST\" enctype=\"multipart/form-data\" class=\"well-sol span6 form-horizontal\" name=\"ajax-demo\" id =\"ajax-demo\">
...
<form action=\"sol.php\" method = \"POST\" enctype=\"multipart/form-data\">
  ...
  sol :<input type=\"radio\" id=\"radio\" name = \"label\"  value = \"sol\"  ".((isset($label) && $label == "sol")  ? "checked = 'checked'" : "")." />
...
<!-- the post text area -->
<form action=\"sol.php\" method = \"POST\" enctype=\"text/plain\" >
sol :<input type=\"radio\" id=\"radio\" name = \"text_label\"  value = \"sol\"  ".((isset($text_label) && $text_label == "sol")  ? "checked = 'checked'" : "")." />
